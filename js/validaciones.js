...
function validarRegistro() {
  ...
  if (
    ...
    mensajeError.innerHTML =
      "Ocurrió un error al registrarse, uno o más de sus datos son incorrectos.";
...
function validarModificarPelicula() {
  ...
  var portada =
    document.forms["form-editarInformacionPelicula"]["portada"].value;
  var descripcion =
    document.forms["form-editarInformacionPelicula"]["descripcion"].value;
  var duracion =
    document.forms["form-editarInformacionPelicula"]["duracion"].value;
  var actores =
    document.forms["form-editarInformacionPelicula"]["actores"].value;
  var categoria =
    document.forms["form-editarInformacionPelicula"]["categoria"].value;
